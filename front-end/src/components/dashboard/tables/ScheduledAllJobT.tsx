...
import {getRows} from './ScheduledAllJobTM'
import {useTypesSelector} from "../../../hooks/menuTypesSelector";
import { useDispatch } from 'react-redux';
import { fetchDriverAllJobs } from '../../../store/action-creators/jobcall';
...
export default function ScheduledAllJobTable() {
