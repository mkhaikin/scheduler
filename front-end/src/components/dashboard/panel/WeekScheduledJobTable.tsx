...
import { fetchWeekJobs, deleteJob } from '../../../store/action-creators/jobcall';
import {
  GridColDef,
  GridApi,
  //GridCellValue
...
import {SchedulForm} from '../Forms/order/SchedulForm'

export default function WeekScheduledJobTable() {
  ...
  return (
    <div style={{ height: 300, width: '100%' }}> 
      ...
      { openEditDialog ? <UpdateOrderForm indJ = {editJobId}  routeJ={editRouteId} driverJ={editDriverId} scheduledJ={editScheduled} closeDialog={setOpenClose} /> :
         <DataGrid rows={getRows(jobs)} columns={cols} pageSize={15} checkboxSelection rowHeight={30} />
      }
      {
        !openEditDialog?  <SchedulForm/>: null
      }
